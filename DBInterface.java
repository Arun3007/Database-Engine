...
public class DBInterface {
    ...
    static public String query(String a_query, String url,
        ...
        String results = "";
        System.out.println("SQL query : " +a_query);
        ...
        try {
            ...
            try {
                ...
                System.out.println("NO result set"+se);
            }
    ...
    static private String resultSetToString(ResultSet rs) throws SQLException {
     ...
     static public String [] getColumnNames(String table_name, String url, String user_id, String passwd) {
        System.out.println("Table_name"+table_name+" URL IS "+url+" USER ID "+user_id+"PASS "+passwd);
        String ret [] = null;
        try {
     ...
     static public String [] getColumnTypes(String table_name, String url, String user_id, String passwd) {
        String ret []= null;
        try {
            ...
            ret = new String[numCols];
            for (int i=0; i<numCols; i++) {
                ret[i] = meta.getColumnTypeName(i + 1);
            }
            rs.close();
            stmt.close();
            con.close();
        } catch (Exception e) {
            System.out.println("Error getting column Types: " + e);
            return null;
        }
        return ret;
    } 
    ...
    static public boolean checkConnection(SQLWarning warning)
        throws SQLException  {
        boolean ret = false;
        if (warning != null) {
            System.out.println("\n *** Warning ***\n");
